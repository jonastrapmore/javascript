...
function output(books, maxYear){
    return books.filter(book=>book.published <= maxYear)
}

const filterdbooks = output(books, 1900)
filterdbooks.forEach(book => console.log(book.getinfo()))